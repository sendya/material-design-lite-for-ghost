...
jQuery(document).ready(function($){
	$('#fixed-header-drawer-exp').blur(function(){$('.site-header').removeClass('change-bg');$('.mdl-layout__drawer-button').css('color','');$(this).css("border-bottom","");$('.mdl-navigation').css('display','');});
	$('#fixed-header-drawer-exp').focus(function(){$('.site-header').addClass('change-bg');$('.mdl-layout__drawer-button').css('color','#666');$(this).css("border-bottom","1px solid #666");$('.mdl-navigation').hide();});
    $("#mdl-navdrawer").prepend($("#mdl-navigation-top").html());//navmenu move to drawer
	$(".scrollTop").click(function(){ $('.mdl-layout__content').animate({scrollTop:0},500); return false; });
	$(".mdl-layout__content").scroll(function(){if($(".mdl-layout__content").scrollTop()>600){$(".scrollTop").show();}else{$(".scrollTop").hide();}});
	
	console.log(" 嘿~ 你居然看我源代码..");
});